                                ...
                                @foreach($vendorOrders as $vendorOrder)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($vendorOrder->status === 'ready_for_pickup')
                                                <span class="badge bg-primary">
                                                    <i class="bi bi-cart-check me-1"></i>{{ __('Ready for Delivery') }}
                                                </span>
                                            @elseif($vendorOrder->status === 'picked_up')
                                                <span class="badge bg-primary">
                                                    <i class="bi bi-check-circle me-1"></i>{{ __('Picked Up') }}
                                                </span>
                                            @elseif($vendorOrder->status === 'in_transit')
                                                <span class="badge bg-primary">
                                                    <i class="bi bi-check-circle me-1"></i>{{ __('In Transit') }}
                                                </span>
                                            @elseif($vendorOrder->status === 'delivered')
                                                <span class="badge bg-primary">
                                                    <i class="bi bi-check-circle me-1"></i>{{ __('Delivered') }}
