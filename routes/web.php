...
Route::group(['middleware' => 'locale'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'vendor', 'as' => 'vendor.', 'middleware' => 'vendor.user'], function () {
            ...
            // });
            Route::post('vendor-users/{vendor_user}/toggle-active', [\App\Http\Controllers\Vendor\VendorUserController::class, 'toggleActive'])->name('vendor-users.toggle-active')->middleware('role_or_permission:vendor|manage-vendor-users');
